...
export default function KonsultacjePage() {
  ...
  const [meetings] = useState<Meeting[]>([
    {
      ...
      description: 'Pierwsze spotkanie konsultacyjne dotyczące planowanej reformy systemu opieki zdrowotnej.'
    },
    {
      id: 'm2',
      ...
      description: 'Webinar konsultacyjny dotyczący zmian w systemie edukacji podstawowej i średniej.'
    },
    {
      id: 'm3',
  ...
  const getMeetingTypeIcon = (type: string) => {
    switch (type) {
      case 'online': return <IconVideo size={16} />;
      case 'offline': return <IconMapPin size={16} />;
      case 'hybrid': return <IconUsers size={16} />;
  ...
  return (
    <Container size="xl" py="xl">
      <Stack gap="xl">
        <div>
          <Title order={1} mb="md">Konsultacje społeczne</Title>
          <Text size="lg" c="dimmed">
            Weź udział w szerokich konsultacjach społecznych dotyczących ważnych reform i zmian legislacyjnych. 
            Twój głos ma znaczenie w kształtowaniu przyszłości.
          </Text>
        </div>
                ...
                <Stack justify="space-between" h="100%">
                  <div>
                    ...
                    {project.status === 'active' && (
                      <div>
                        <Group justify="space-between" mb="xs">
                          <Text size="sm" fw={500}>Postęp konsultacji</Text>
        ...
        {/* Nadchodzące spotkania */}
        <div>
          <Title order={2} mb="md">Nadchodzące spotkania</Title>
          <Grid>
            {meetings
              ...
              <Grid.Col key={meeting.id} span={{ base: 12, md: 6, lg: 4 }}>
                <Card shadow="sm" padding="lg" radius="md" withBorder>
                  <Group justify="space-between" mb="xs">
                    ...
                    >
                      {meeting.type === 'online' ? 'Online' : 
                       meeting.type === 'offline' ? 'Stacjonarnie' : 'Hybrydowo'}
                    </Badge>
                  ...
                  <Stack gap="xs" mb="md">
                    ...
                    <Group gap="xs">
                      <IconMapPin size={16} />
                      <Text size="sm" lineClamp={1}>{meeting.location}</Text>
                    </Group>
          ...
          <Tabs defaultValue="details">
            ...
            <Tabs.Panel value="details" pt="md">
              <Stack gap="md">
                ...
                <div>
                  <Text fw={600} mb="md">Kontakt</Text>
                  <Stack gap="xs">
                    <Group gap="xs">
                      <IconMail size={16} />
                      <Anchor size="sm">konsultacje@{selectedProject.institution.toLowerCase().replace(/\s+/g, '')}.gov.pl</Anchor>
                    </Group>
                    <Group gap="xs">
                      <IconPhone size={16} />
            ...
            <Tabs.Panel value="timeline" pt="md">
              <Timeline active={2} bulletSize={24} lineWidth={2}>
                ...
                <Timeline.Item
                  ...
                  title="Analiza otrzymanych uwag"
                >
                  <Text c="dimmed" size="sm">
                    Obecnie w trakcie
                  </Text>
            ...
            <Tabs.Panel value="participants" pt="md">
              <Stack gap="md">
                <Group justify="space-between">
                  ...
                  <Text c="dimmed" size="sm">Łącznie: {selectedProject.participantsCount}</Text>
                </Group>
                
                <SimpleGrid cols={2} spacing="md">
                  <Paper p="md" withBorder>
                    <Text size="sm" c="dimmed">Organizacje pozarządowe</Text>
                    <Text fw={600} size="lg">23%</Text>
                  </Paper>
                  <Paper p="md" withBorder>
                    <Text size="sm" c="dimmed">Obywatele</Text>
                    <Text fw={600} size="lg">45%</Text>
                  </Paper>
                  <Paper p="md" withBorder>
                    <Text size="sm" c="dimmed">Przedsiębiorcy</Text>
                    <Text fw={600} size="lg">19%</Text>
                  </Paper>
                  <Paper p="md" withBorder>
                    <Text size="sm" c="dimmed">Eksperci</Text>
                    <Text fw={600} size="lg">13%</Text>
                  </Paper>
                </SimpleGrid>
              </Stack>
            </Tabs.Panel>
                  ...
                  <Paper key={i} p="md" withBorder>
                    <Group justify="space-between">
                      <div>
                        ...
                        <Text size="sm" c="dimmed">
                          {i === 0 ? 'Główny projekt dokumentu' : 
                           i === 1 ? 'Uzasadnienie' :
                           i === 2 ? 'Ocena skutków regulacji' :
                           `Załącznik ${i - 2}`}
                        </Text>
                      </div>
